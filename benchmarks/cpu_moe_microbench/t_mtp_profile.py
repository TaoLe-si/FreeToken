...
sticky = IgpuFcSticky(igpu, fc_packed_1, 4096)
...
print(f'Component timings (dGPU, except fc which is iGPU):')
print(f'  embed:  {t_emb:.3f}ms')
print(f'  attn:   {t_attn:.3f}ms')
print(f'  MoE:    {t_moe:.3f}ms')
print(f'  lm_head: {t_lm:.3f}ms')
print(f'  fc (iGPU+IPC): {t_fc:.3f}ms')
print(f'  Sum: {t_emb+t_attn+t_moe+t_lm+t_fc:.3f}ms')
print(f'This breakdown explains where to focus iGPU offload: MoE and attn are the bottlenecks.')
