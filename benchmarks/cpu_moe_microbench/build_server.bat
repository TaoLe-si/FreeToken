...
"%MSVC%\bin\Hostx64\x64\cl.exe" /EHsc /O2 /std:c++17 ^
  ...
  t_mtp_fc_server.cpp /Fe:t_mtp_fc_server.exe /link /LIBPATH:"%MSVC%\lib\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\ucrt\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\um\x64" d3d12.lib dxgi.lib
