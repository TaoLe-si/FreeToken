...
"%MSVC%\bin\Hostx64\x64\cl.exe" /nologo /EHsc /O2 /std:c++17 ^
  ...
  E:\FreeToken\benchmarks\cpu_moe_microbench\t_stdin_test.cpp /Fe:E:\FreeToken\benchmarks\cpu_moe_microbench\t_stdin_test.exe /link /LIBPATH:"%MSVC%\lib\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\ucrt\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\um\x64"
