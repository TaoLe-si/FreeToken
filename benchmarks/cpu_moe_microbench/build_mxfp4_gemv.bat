...
echo === Building MXFP4 GEMV ===
"%DXC%" -T cs_6_0 -E main -Fo t_mxfp4_gemv_sk.dxil t_mxfp4_gemv_d3d12.hlsl
...
"%MSVC%\bin\Hostx64\x64\cl.exe" /EHsc /O2 /std:c++17 ^
  ...
  /I"%WINSDK%\Include\10.0.26100.0\winrt" ^
  /I"%WINSDK%\Include\10.0.26100.0\cppwinrt" ^
  t_mxfp4_gemv_d3d12.cpp ^
  /Fe:t_mxfp4_gemv_d3d12.exe ^
  /link /LIBPATH:"%MSVC%\lib\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\ucrt\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\um\x64" d3d12.lib dxgi.lib
