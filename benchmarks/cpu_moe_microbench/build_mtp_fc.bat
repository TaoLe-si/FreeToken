...
"%DXC%" -T cs_6_0 -E main -Fo t_nvfp4_gemv_sk.dxil t_nvfp4_gemv_d3d12.hlsl
...
"%MSVC%\bin\Hostx64\x64\cl.exe" /EHsc /O2 /std:c++17 ^
  ...
  t_mtp_fc_test.cpp /Fe:t_mtp_fc_test.exe /link /LIBPATH:"%MSVC%\lib\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\ucrt\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\um\x64" d3d12.lib dxgi.lib
