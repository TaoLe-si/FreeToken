...
"%MSVC%\bin\Hostx64\x64\cl.exe" /nologo /EHsc /O2 /std:c++17 ^
  ...
  E:\FreeToken\benchmarks\cpu_moe_microbench\t_mxfp4_gemv_sticky_server.cpp /Fe:E:\FreeToken\benchmarks\cpu_moe_microbench\t_mxfp4_gemv_sticky_server.exe /link d3d12.lib dxgi.lib /LIBPATH:"%MSVC%\lib\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\ucrt\x64" /LIBPATH:"%WINSDK%\Lib\10.0.26100.0\um\x64"
